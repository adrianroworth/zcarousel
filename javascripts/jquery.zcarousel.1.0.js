(function ($) {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.children().each(function() {
                    ...
                    var caption = $(this).attr('data-' + namespace_lc + '-item-caption');
                ...
                if($this.data(namespace_lc + '.settings').nav != true) {
                    $this.data(namespace_lc + '.settings').nav = false
                    $this.data(namespace_lc + '.settings').navActiveMarker = false
                } else if($this.data(namespace_lc + '.settings').nav == false) {
                    $this.data(namespace_lc + '.settings').nav = false
                    $this.data(namespace_lc + '.settings').navActiveMarker = false
                }
    ...
    $.fn[namespace].defaults = {
        ...
        'nav': false, // show slide navigation. Can be 'true' or 'false'.
